...
@Component({
  ...
  styleUrls: ['./attributes.component.scss', '../layout/docs-layout.component.scss'],
  imports: [CommonModule, RouterModule, ButtonModule, HighlightModule, CopyButtonComponent],
})
