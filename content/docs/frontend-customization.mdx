...
| File                                                                    | Purpose                                           |
| ----------------------------------------------------------------------- | ------------------------------------------------- |
| `Frontend\src\app\business\entities\entities.generated.ts`              | TypeScript classes mirroring your C# DTOs         |
| `Frontend\src\app\business\services\api\api.service.generated.ts`       | Strongly-typed API service methods                |
| `Frontend\src\app\business\components\base-details.generated.ts`        | Base detail components for entity forms           |
| `Frontend\src\app\business\services\validators\validators.generated.ts` | Form validators matching your C# validation rules |
| `Frontend\src\app\business\services\translates\translates.generated.ts` | Translation keys                                  |
| `Frontend\src\app\business\enums\enums.generated.ts`                    | TypeScript enums matching your C# enums           |
