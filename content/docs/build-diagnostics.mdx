...
**Fix:** give every blob property a distinct, non-nested, lowercase kebab-case prefix (`"products"` and `"product-thumbs"` are fine together; `"products"` and `"products/thumbs"` are not).
