...
| `showHoverBgOnRootTopMenuItems` | `boolean` | `false` | Background color on hover for root top menu items (top menu layout only) |
| `maxWidth` | `string` | `'1100px'` | CSS `max-width` for the main content area (top menu layout only) |
