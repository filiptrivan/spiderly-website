---
title: Customizing Spiderly Application's UI
...
ℹ️ If your logo file is not named `logo.svg` or you want to use a custom path, open the `src\app\business\services\config.service.ts` file and override the logo path like this:
