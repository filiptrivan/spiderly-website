...
Use the UI of your generated app to register the user via email (because you still didn't set up real email authentication the code will be shown in the `DEBUG CONSOLE` window):
IMAGE