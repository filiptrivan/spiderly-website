---
title: Spiderly Attributes
description: Complete reference for all Spiderly attributes used in entity configuration, UI generation, and authorization.
---
