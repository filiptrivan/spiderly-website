...
export const LampContainer = ({
  ...
  return (
    <div
      className={cn(
        'flex relative md:min-h-screen flex-col items-center justify-center overflow-hidden w-full rounded-md z-0',
        className,
      )}
    >
      ...
      <div className="relative z-50 flex md:-translate-y-96 flex-col items-center">{children}</div>
    </div>
  );
};
