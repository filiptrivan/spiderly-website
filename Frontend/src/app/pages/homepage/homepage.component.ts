...
export class HomepageComponent {
  ...
  constructor(
    ...
    this.metaService.updateTag({ name: 'description', content: 'Spiderly is an open-source .NET (C#) boilerplate code generator that turns EF Core model into fully customizable .NET (C#) + Angular web application.' });
